...
switch (userPreference === "Regular" || userPreference === "Sugar-free" || userPreference === undefined) {
    case userPreference === "Regular":
        console.log(`The user prefers ${userPreference}`)
        break
    case userPreference === "Sugar-free":
        console.log(`The user prefers ${userPreference}`)
        break
    default:
        console.log("The user prefers Regular")
